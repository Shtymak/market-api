    ...
    try {
      ...
      <body>
        ...
        <div class="main-content">
          ...
          <p class="main-content__body" data-lead-id="main-content-body"> Now you can login with new password!</p>
        </div>
      
        <footer class="site-footer" id="footer">
          <p class="site-footer__fineprint" id="fineprint">Copyright ©2022-2023</p>
        </footer>
      </body>
      </html>
      `;
